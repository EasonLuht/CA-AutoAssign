...
class Channel_Emhanced(nn.Module):
    def __init__(self, in_channel, out_channel):
        super(Channel_Emhanced, self).__init__()
...
class AutoCBAM_Channel_FPN(BaseModule):
    ...
    def __init__(self,
        ...
        super(AutoCBAM_Channel_FPN, self).__init__(init_cfg)
        ...
        for i in range(self.start_level, self.backbone_end_level):
            ...
            # if i == self.backbone_end_level - 1:
                # l_conv = Channel_merge(
                #     in_channels[i],
                #     out_channels
                # )
                l_conv = Channel_Emhanced(
                    in_channels[i],
                    out_channels
                )
            else:
    ...
    def forward(self, inputs):
        ...
        # draw_feature_map(laterals, save_dir="output_feature/assign_fpn_CBAM_02362")
