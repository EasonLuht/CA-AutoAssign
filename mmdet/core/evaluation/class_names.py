...
def voc_classes():
    ...
    # return [
    #     'bug','color shade','defect','dirty','flaw','fold','hair','hole','miss print','pattern error','scrimp','sewing','sewing print','watermark','wax spot'
    # ]
    return [
        'sewing', 'sewing_print', 'miss_print', 'bug', 'color_shade', 'scrimp', 'hole', 'flaw', 'fold'
    ]
    # return [
    #     'crazing', 'inclusion', 'patches', 'pitted_surface', 'rolled-in_scale', 'scratches'
    # ]
    # return [
    #     'tower', 'insulator', 'spacer', 'damper', 'plate'
    # ]
...
def coco_classes():
    ...
    return [
        'sewing', 'sewing print', 'miss_print', 'bug', 'color_shade', 'scrimp', 'hole', 'flaw', 'fold'
    ]
